      ...
      >
        <View style={styles.saleHeader}>
          <View style={styles.saleIdContainer}>
            <Icon name="receipt-outline" size={13} color="#6B7280" />
        ...
        <View style={styles.modalContent}>
          <View style={styles.modalHeader}>
            <View style={styles.modalHeaderContent}>
              <Icon name="receipt-outline" size={22} color="#3d2b1f" />
            ...
            <View style={styles.detailSection}>
              <View style={styles.detailItemRow}>
                <View style={styles.detailIconContainer}>
                  <Icon name="pricetag-outline" size={14} color="#f4a900" />
                </View>
              ...
              <View style={styles.detailItemRow}>
                <View style={styles.detailIconContainer}>
                  <Icon name="calendar-outline" size={14} color="#f4a900" />
                </View>
                <View style={styles.detailContent}>
              ...
              <View style={styles.detailItemRow}>
                <View style={styles.detailIconContainer}>
                  <Icon name="person-outline" size={14} color="#f4a900" />
                </View>
                <View style={styles.detailContent}>
              ...
              <View style={styles.detailItemRow}>
                <View style={styles.detailIconContainer}>
                  <Icon name="card-outline" size={14} color="#f4a900" />
                </View>
                <View style={styles.detailContent}>
                    ...
                    <View style={styles.itemInfo}>
                      ...
                      <View style={styles.itemDetails}>
                        ...
                        <View style={styles.itemProfitBadge}>
                          <Icon name="trending-up" size={9} color="#10B981" />
